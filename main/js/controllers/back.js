...
MetronicApp.controller('GeneralPageController', ['$rootScope', '$scope', '$http', 'settings', function($rootScope, $scope, $http, settings) {
    $scope.$on('$viewContentLoaded', function() {
        ...
        queryDataFunc = function() {
            ...
            queryData = $('#masukContainer').DataTable({
            ...
            queryData = $('#paspelajarContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=paspelajar",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#paskerjaContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=paskerja",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#tanggunganContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=tanggungan",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#plsContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=pls",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#plikContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=plik",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#pengecualianContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=pengecualian",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#plksContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=plks",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#mm2hContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=mm2h",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#visaContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=visa",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#khasContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=khas",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#pasanganContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=pasangan",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#pengajianContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=pengajian",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#penguatkuasaanContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=penguatkuasaan",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
            ...
            queryData = $('#reportingContainer').DataTable({

                "ajax": {
                    "processing": true,
                    "serverSide": true,
                    "url": "http://10.1.17.25:8080/query?cat=reporting",
                    "dataSrc": ""
                },
                "columns": [{
                    "data": "id"
