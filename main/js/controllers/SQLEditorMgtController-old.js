        ...
        // fn_showHistory();
           ...
           $scope.IntroOptions = {
            ...
            },
            {
                ...
                intro: "Active database <strong> Click </strong>to show list of available database<BR> \
                Database are listed based on permission, Please contact Admin if required database is not shown",
                position: 'right'
            },
            {
                element: document.querySelector('#lstDBtbl'),
                intro: "Tables under the selected database",
                position: 'right'
            },
            {
